...
[![npm package](https://img.shields.io/npm/v/@taktikorg/facere-doloremque.svg)](https://npmjs.org/package/@taktikorg/facere-doloremque)
...
DevTools frontend repository is mirrored on [GitHub](https://github.com/taktikorg/facere-doloremque).

DevTools frontend is also available on NPM as the [@taktikorg/facere-doloremque](https://www.npmjs.com/package/@taktikorg/facere-doloremque) package. It's not currently available via CJS or ES modules, so consuming this package in other tools may require [some effort](https://github.com/paulirish/devtools-timeline-model/blob/master/index.js).
